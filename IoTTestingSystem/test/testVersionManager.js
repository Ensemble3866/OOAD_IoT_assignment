...
describe('#TestVersionManager', function() {
    ...
    describe('MakeVersionsSameCategory()', () => {
    ...
    describe('RemoveVersion()', () => {
        it('should remove the version', function() {
            var testVersionManager = new TestVersionManager();
            testVersionManager.MakeNewVersion("Android 5.01", "Phone");
            testVersionManager.MakeNewVersion("Android 5.02", "Phone");
            testVersionManager.MakeNewVersion("Android Oreo", "Phone");
            ...
            testVersionManager.RemoveVersion('Android 5.02', 'Phone');
            var versions = testVersionManager.GetVersionByCategory('Phone');
            assert.equal(versions[1].name, 'Android Oreo',  'name should be Android Oreo');
        });
    });
});
